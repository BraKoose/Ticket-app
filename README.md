...
Ticketing CRM API system with MERN stack. This is final Year School Project at OpenLabs GIZ Sscholarship 

## How to use

- run `git clone https://github.com/BraKoose/Ticket-app
- run `npm install`
- run `npm start`
